...
public abstract class ValueMapping<KeyType, IndexType, PointType extends Comparable<PointType>> {
  ...
  protected PointType zeroValue;
  protected PointType oneValue;
  protected BiFunction<PointType, PointType, PointType> pointTypeDiv;
  protected BiFunction<PointType, PointType, PointType> pointTypeMod;
