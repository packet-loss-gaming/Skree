...
public class UnleashedSword extends CustomSword implements Craftable {
    ...
    public ItemStack __getRepairItemStack() {
        return new ItemStack(CustomItemTypes.HOLY_SWORD);
    }
    ...
    public void registerRecipes() {
        GameRegistry.addShapelessRecipe(
                new ItemStack(this),
                new ItemStack(CustomItemTypes.HOLY_SWORD),
