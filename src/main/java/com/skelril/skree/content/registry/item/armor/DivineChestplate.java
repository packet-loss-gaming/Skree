...
public class DivineChestplate extends CustomChestplate implements Craftable {
    @Override
    ...
    public ItemStack __getRepairItemStack() {
        return new ItemStack(CustomItemTypes.GUARDIAN_CHESTPLATE);
    }
    ...
    public void registerRecipes() {
        GameRegistry.addShapelessRecipe(
                new ItemStack(this),
                new ItemStack(CustomItemTypes.GUARDIAN_CHESTPLATE),
