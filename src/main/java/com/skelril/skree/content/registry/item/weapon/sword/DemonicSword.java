...
public class DemonicSword extends CustomSword implements Craftable {
    ...
    public ItemStack __getRepairItemStack() {
        return new ItemStack(CustomItemTypes.DEMONIC_INGOT);
    }
    ...
    public void registerRecipes() {
        GameRegistry.addShapelessRecipe(
                new ItemStack(this),
                new ItemStack(CustomItemTypes.DEMONIC_BLADE),
                new ItemStack(CustomItemTypes.DEMONIC_HILT)
        );
    }
}