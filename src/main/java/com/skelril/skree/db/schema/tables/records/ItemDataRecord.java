...
public class ItemDataRecord extends UpdatableRecordImpl<ItemDataRecord> implements Record7<Integer, String, String, BigDecimal, BigDecimal, Integer, Integer> {

	private static final long serialVersionUID = -313873590;
	...
	/**
	 * Setter for <code>mc_db.item_data.current_value</code>.
	 */
	...
	/**
	 * Getter for <code>mc_db.item_data.current_value</code>.
	 */
	...
	/**
	 * Setter for <code>mc_db.item_data.stock</code>.
	 */
	...
	/**
	 * Getter for <code>mc_db.item_data.stock</code>.
	 */
	 ...
	 */
	@Override
	public Row7<Integer, String, String, BigDecimal, BigDecimal, Integer, Integer> fieldsRow() {
	 ...
	 */
	@Override
	public Row7<Integer, String, String, BigDecimal, BigDecimal, Integer, Integer> valuesRow() {
	...
	public Field<BigDecimal> field5() {
		return ItemData.ITEM_DATA.CURRENT_VALUE;
	}
	...
	public Field<Integer> field6() {
		return ItemData.ITEM_DATA.STOCK;
	}
	 ...
	 */
	@Override
	public ItemDataRecord value5(BigDecimal value) {
	 ...
	 */
	@Override
	public ItemDataRecord value6(Integer value) {
		setStock(value);
		return this;
	}
	 ...
	 */
	@Override
	public ItemDataRecord value7(Integer value) {
	 ...
	 */
	@Override
	public ItemDataRecord values(Integer value1, String value2, String value3, BigDecimal value4, BigDecimal value5, Integer value6, Integer value7) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ItemDataRecord(Integer id, String mcId, String variant, BigDecimal value, BigDecimal currentValue, Integer stock, Integer primary_alias) {
		super(ItemData.ITEM_DATA);
		...
		setValue(2, variant);
		setValue(3, value);
		setValue(4, currentValue);
		setValue(5, stock);
		setValue(6, primary_alias);
	}
}
